...
$admin_edit = NULL; // Initialize page object first

class cadmin_edit extends cadmin {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_admin_id")) {
				$this->admin_id->setFormValue($objForm->GetValue("x_admin_id"));
			}
		} else {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->admin_id->FldIsDetailKey)
			$this->admin_id->setFormValue($objForm->GetValue("x_admin_id"));
...
// Create page object
if (!isset($admin_edit)) $admin_edit = new cadmin_edit();
...
var CurrentForm = fadminedit = new ew_Form("fadminedit", "edit");
...
fadminedit.Form_CustomValidate = 
...
fadminedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fadminedit" id="fadminedit" class="<?php echo $admin_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($admin_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $admin_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="admin">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($admin_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($admin->admin_id->Visible) { // admin_id ?>
	<div id="r_admin_id" class="form-group">
		<label id="elh_admin_admin_id" class="<?php echo $admin_edit->LeftColumnClass ?>"><?php echo $admin->admin_id->FldCaption() ?></label>
		<div class="<?php echo $admin_edit->RightColumnClass ?>"><div<?php echo $admin->admin_id->CellAttributes() ?>>
<span id="el_admin_admin_id">
<span<?php echo $admin->admin_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $admin->admin_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="admin" data-field="x_admin_id" name="x_admin_id" id="x_admin_id" value="<?php echo ew_HtmlEncode($admin->admin_id->CurrentValue) ?>">
<?php echo $admin->admin_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($admin->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_admin_name" for="x_name" class="<?php echo $admin_edit->LeftColumnClass ?>"><?php echo $admin->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $admin_edit->RightColumnClass ?>"><div<?php echo $admin->name->CellAttributes() ?>>
...
<?php if ($admin->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_admin__email" for="x__email" class="<?php echo $admin_edit->LeftColumnClass ?>"><?php echo $admin->_email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($admin->password->Visible) { // password ?>
	<div id="r_password" class="form-group">
		<label id="elh_admin_password" for="x_password" class="<?php echo $admin_edit->LeftColumnClass ?>"><?php echo $admin->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($admin->level->Visible) { // level ?>
	<div id="r_level" class="form-group">
		<label id="elh_admin_level" for="x_level" class="<?php echo $admin_edit->LeftColumnClass ?>"><?php echo $admin->level->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($admin->authentication_key->Visible) { // authentication_key ?>
	<div id="r_authentication_key" class="form-group">
		<label id="elh_admin_authentication_key" for="x_authentication_key" class="<?php echo $admin_edit->LeftColumnClass ?>"><?php echo $admin->authentication_key->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $admin_edit->RightColumnClass ?>"><div<?php echo $admin->authentication_key->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $admin_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
