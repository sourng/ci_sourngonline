...
$admin_view = NULL; // Initialize page object first

class cadmin_view extends cadmin {
...
// Create page object
if (!isset($admin_view)) $admin_view = new cadmin_view();
...
var CurrentForm = fadminview = new ew_Form("fadminview", "view");

// Form_CustomValidate event
fadminview.Form_CustomValidate = 
...
fadminview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fadminview" id="fadminview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($admin_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $admin_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="admin">
<input type="hidden" name="modal" value="<?php echo intval($admin_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($admin->admin_id->Visible) { // admin_id ?>
	<tr id="r_admin_id">
		<td class="col-sm-2"><span id="elh_admin_admin_id"><?php echo $admin->admin_id->FldCaption() ?></span></td>
...
<?php echo $admin->admin_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admin->name->Visible) { // name ?>
	<tr id="r_name">
		<td class="col-sm-2"><span id="elh_admin_name"><?php echo $admin->name->FldCaption() ?></span></td>
		<td data-name="name"<?php echo $admin->name->CellAttributes() ?>>
<span id="el_admin_name">
<span<?php echo $admin->name->ViewAttributes() ?>>
<?php echo $admin->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($admin->password->Visible) { // password ?>
	<tr id="r_password">
		<td class="col-sm-2"><span id="elh_admin_password"><?php echo $admin->password->FldCaption() ?></span></td>
...
<?php echo $admin->password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admin->level->Visible) { // level ?>
	<tr id="r_level">
		<td class="col-sm-2"><span id="elh_admin_level"><?php echo $admin->level->FldCaption() ?></span></td>
		<td data-name="level"<?php echo $admin->level->CellAttributes() ?>>
<span id="el_admin_level">
<span<?php echo $admin->level->ViewAttributes() ?>>
<?php echo $admin->level->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admin->authentication_key->Visible) { // authentication_key ?>
	<tr id="r_authentication_key">
		<td class="col-sm-2"><span id="elh_admin_authentication_key"><?php echo $admin->authentication_key->FldCaption() ?></span></td>
		<td data-name="authentication_key"<?php echo $admin->authentication_key->CellAttributes() ?>>
<span id="el_admin_authentication_key">
<span<?php echo $admin->authentication_key->ViewAttributes() ?>>
<?php echo $admin->authentication_key->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
