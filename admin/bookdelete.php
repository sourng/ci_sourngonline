...
fbookdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($book->book_id->Visible) { // book_id ?>
		<th class="<?php echo $book->book_id->HeaderCellClass() ?>"><span id="elh_book_book_id" class="book_book_id"><?php echo $book->book_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
