...
//
// Table class for book
//
class cbook extends cTable {
	var $book_id;
	var $name;
	var $description;
	var $author;
	...
	function __construct() {
		...
		// book_id
		$this->book_id = new cField('book', 'book', 'x_book_id', 'book_id', '`book_id`', '`book_id`', 3, -1, FALSE, '`book_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// name
		$this->name = new cField('book', 'book', 'x_name', 'name', '`name`', '`name`', 201, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->name->Sortable = TRUE; // Allow sort
		$this->fields['name'] = &$this->name;

		// description
		$this->description = new cField('book', 'book', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// author
		$this->author = new cField('book', 'book', 'x_author', 'author', '`author`', '`author`', 201, -1, FALSE, '`author`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->author->Sortable = TRUE; // Allow sort
		$this->fields['author'] = &$this->author;

		// class_id
		$this->class_id = new cField('book', 'book', 'x_class_id', 'class_id', '`class_id`', '`class_id`', 201, -1, FALSE, '`class_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->class_id->Sortable = TRUE; // Allow sort
		$this->fields['class_id'] = &$this->class_id;

		// status
		$this->status = new cField('book', 'book', 'x_status', 'status', '`status`', '`status`', 201, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->status->Sortable = TRUE; // Allow sort
		$this->fields['status'] = &$this->status;

		// price
		$this->price = new cField('book', 'book', 'x_price', 'price', '`price`', '`price`', 201, -1, FALSE, '`price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`book`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "bookedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "bookadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("bookview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("bookview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "bookadd.php?" . $this->UrlParm($parm);
		else
			$url = "bookadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("bookedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("bookadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("bookdelete.php", $this->UrlParm());
	}
