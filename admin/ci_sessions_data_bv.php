...
$ci_sessions_data_blobview = NULL; // Initialize page object first

class cci_sessions_data_blobview extends cci_sessions {
	...
	// Page object name
	var $PageObjName = 'ci_sessions_data_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'ci_sessions');
		if (!$Security->CanList()) {
			$this->Page_Terminate();
		}
...
// Create page object
if (!isset($ci_sessions_data_blobview)) $ci_sessions_data_blobview = new cci_sessions_data_blobview();

// Page init
$ci_sessions_data_blobview->Page_Init();

// Page main
$ci_sessions_data_blobview->Page_Main();
?>
<?php
$ci_sessions_data_blobview->Page_Terminate();
?>
