...
class cci_sessions_edit extends cci_sessions {
	...
	function RenderRow() {
		...
		$this->data->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->data);
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// data
			if ($this->data->Visible && !$this->data->ReadOnly && !$this->data->Upload->KeepFile) {
...
fci_sessionsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($ci_sessions_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($ci_sessions->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_ci_sessions_id" for="x_id" class="<?php echo $ci_sessions_edit->LeftColumnClass ?>"><?php echo $ci_sessions->id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ci_sessions_edit->RightColumnClass ?>"><div<?php echo $ci_sessions->id->CellAttributes() ?>>
<span id="el_ci_sessions_id">
<span<?php echo $ci_sessions->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $ci_sessions->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ci_sessions" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($ci_sessions->id->CurrentValue) ?>">
...
<?php if ($ci_sessions->ip_address->Visible) { // ip_address ?>
	<div id="r_ip_address" class="form-group">
		<label id="elh_ci_sessions_ip_address" for="x_ip_address" class="<?php echo $ci_sessions_edit->LeftColumnClass ?>"><?php echo $ci_sessions->ip_address->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ci_sessions_edit->RightColumnClass ?>"><div<?php echo $ci_sessions->ip_address->CellAttributes() ?>>
...
<?php if ($ci_sessions->timestamp->Visible) { // timestamp ?>
	<div id="r_timestamp" class="form-group">
		<label id="elh_ci_sessions_timestamp" for="x_timestamp" class="<?php echo $ci_sessions_edit->LeftColumnClass ?>"><?php echo $ci_sessions->timestamp->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ci_sessions_edit->RightColumnClass ?>"><div<?php echo $ci_sessions->timestamp->CellAttributes() ?>>
...
<?php if ($ci_sessions->data->Visible) { // data ?>
	<div id="r_data" class="form-group">
		<label id="elh_ci_sessions_data" class="<?php echo $ci_sessions_edit->LeftColumnClass ?>"><?php echo $ci_sessions->data->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ci_sessions_edit->RightColumnClass ?>"><div<?php echo $ci_sessions->data->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ci_sessions_edit->OffsetColumnClass ?>"><!-- buttons offset -->
