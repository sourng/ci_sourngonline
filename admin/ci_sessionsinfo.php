...
//
// Table class for ci_sessions
//
class cci_sessions extends cTable {
	var $id;
	var $ip_address;
	var $timestamp;
	var $data;
	...
	function __construct() {
		...
		$this->TableVar = 'ci_sessions';
		$this->TableName = 'ci_sessions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ci_sessions`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('ci_sessions', 'ci_sessions', 'x_id', 'id', '`id`', '`id`', 200, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id->Sortable = TRUE; // Allow sort
		$this->fields['id'] = &$this->id;

		// ip_address
		$this->ip_address = new cField('ci_sessions', 'ci_sessions', 'x_ip_address', 'ip_address', '`ip_address`', '`ip_address`', 200, -1, FALSE, '`ip_address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ip_address->Sortable = TRUE; // Allow sort
		$this->fields['ip_address'] = &$this->ip_address;

		// timestamp
		$this->timestamp = new cField('ci_sessions', 'ci_sessions', 'x_timestamp', 'timestamp', '`timestamp`', '`timestamp`', 19, -1, FALSE, '`timestamp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->timestamp->Sortable = TRUE; // Allow sort
		$this->timestamp->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['timestamp'] = &$this->timestamp;

		// data
		$this->data = new cField('ci_sessions', 'ci_sessions', 'x_data', 'data', '`data`', '`data`', 205, -1, TRUE, '`data`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ci_sessions`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "ci_sessionsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "ci_sessionsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ci_sessionsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ci_sessionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ci_sessionsadd.php?" . $this->UrlParm($parm);
		else
			$url = "ci_sessionsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ci_sessionsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ci_sessionsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ci_sessionsdelete.php", $this->UrlParm());
	}
