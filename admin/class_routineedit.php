...
$class_routine_edit = NULL; // Initialize page object first

class cclass_routine_edit extends cclass_routine {
	...
	// Page object name
	var $PageObjName = 'class_routine_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_class_routine_id")) {
				$this->class_routine_id->setFormValue($objForm->GetValue("x_class_routine_id"));
			}
		} else {
			...
			$loadByQuery = FALSE;
			if (isset($_GET["class_routine_id"])) {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->class_routine_id->FldIsDetailKey)
			$this->class_routine_id->setFormValue($objForm->GetValue("x_class_routine_id"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->class_routine_id->CurrentValue = $this->class_routine_id->FormValue;
	...
	function RenderRow() {
		...
		$this->day->ViewCustomAttributes = "";
			...
			// class_routine_id
			$this->class_routine_id->EditAttrs["class"] = "form-control";
			$this->class_routine_id->EditCustomAttributes = "";
			$this->class_routine_id->EditValue = $this->class_routine_id->CurrentValue;
			$this->class_routine_id->ViewCustomAttributes = "";
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// time_start
			$this->time_start->SetDbValueDef($rsnew, $this->time_start->CurrentValue, 0, $this->time_start->ReadOnly);

			// time_end
			$this->time_end->SetDbValueDef($rsnew, $this->time_end->CurrentValue, 0, $this->time_end->ReadOnly);

			// time_start_min
			$this->time_start_min->SetDbValueDef($rsnew, $this->time_start_min->CurrentValue, 0, $this->time_start_min->ReadOnly);

			// time_end_min
			$this->time_end_min->SetDbValueDef($rsnew, $this->time_end_min->CurrentValue, 0, $this->time_end_min->ReadOnly);

			// day
			$this->day->SetDbValueDef($rsnew, $this->day->CurrentValue, "", $this->day->ReadOnly);
...
// Create page object
if (!isset($class_routine_edit)) $class_routine_edit = new cclass_routine_edit();

// Page init
$class_routine_edit->Page_Init();

// Page main
$class_routine_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$class_routine_edit->Page_Render();
?>
...
var CurrentForm = fclass_routineedit = new ew_Form("fclass_routineedit", "edit");

// Validate form
fclass_routineedit.Validate = function() {
...
fclass_routineedit.Form_CustomValidate = 
...
fclass_routineedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $class_routine_edit->ShowPageHeader(); ?>
<?php
$class_routine_edit->ShowMessage();
?>
<form name="fclass_routineedit" id="fclass_routineedit" class="<?php echo $class_routine_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($class_routine_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $class_routine_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="class_routine">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($class_routine_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($class_routine->class_routine_id->Visible) { // class_routine_id ?>
	<div id="r_class_routine_id" class="form-group">
		<label id="elh_class_routine_class_routine_id" class="<?php echo $class_routine_edit->LeftColumnClass ?>"><?php echo $class_routine->class_routine_id->FldCaption() ?></label>
		<div class="<?php echo $class_routine_edit->RightColumnClass ?>"><div<?php echo $class_routine->class_routine_id->CellAttributes() ?>>
<span id="el_class_routine_class_routine_id">
<span<?php echo $class_routine->class_routine_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $class_routine->class_routine_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="class_routine" data-field="x_class_routine_id" name="x_class_routine_id" id="x_class_routine_id" value="<?php echo ew_HtmlEncode($class_routine->class_routine_id->CurrentValue) ?>">
<?php echo $class_routine->class_routine_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($class_routine->class_id->Visible) { // class_id ?>
	<div id="r_class_id" class="form-group">
		<label id="elh_class_routine_class_id" for="x_class_id" class="<?php echo $class_routine_edit->LeftColumnClass ?>"><?php echo $class_routine->class_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $class_routine_edit->RightColumnClass ?>"><div<?php echo $class_routine->class_id->CellAttributes() ?>>
...
<?php if ($class_routine->subject_id->Visible) { // subject_id ?>
	<div id="r_subject_id" class="form-group">
		<label id="elh_class_routine_subject_id" for="x_subject_id" class="<?php echo $class_routine_edit->LeftColumnClass ?>"><?php echo $class_routine->subject_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $class_routine_edit->RightColumnClass ?>"><div<?php echo $class_routine->subject_id->CellAttributes() ?>>
...
<?php if ($class_routine->time_start->Visible) { // time_start ?>
	<div id="r_time_start" class="form-group">
		<label id="elh_class_routine_time_start" for="x_time_start" class="<?php echo $class_routine_edit->LeftColumnClass ?>"><?php echo $class_routine->time_start->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $class_routine_edit->RightColumnClass ?>"><div<?php echo $class_routine->time_start->CellAttributes() ?>>
...
<?php if ($class_routine->time_end->Visible) { // time_end ?>
	<div id="r_time_end" class="form-group">
		<label id="elh_class_routine_time_end" for="x_time_end" class="<?php echo $class_routine_edit->LeftColumnClass ?>"><?php echo $class_routine->time_end->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $class_routine_edit->RightColumnClass ?>"><div<?php echo $class_routine->time_end->CellAttributes() ?>>
...
<?php if ($class_routine->time_start_min->Visible) { // time_start_min ?>
	<div id="r_time_start_min" class="form-group">
		<label id="elh_class_routine_time_start_min" for="x_time_start_min" class="<?php echo $class_routine_edit->LeftColumnClass ?>"><?php echo $class_routine->time_start_min->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $class_routine_edit->RightColumnClass ?>"><div<?php echo $class_routine->time_start_min->CellAttributes() ?>>
...
<?php if ($class_routine->time_end_min->Visible) { // time_end_min ?>
	<div id="r_time_end_min" class="form-group">
		<label id="elh_class_routine_time_end_min" for="x_time_end_min" class="<?php echo $class_routine_edit->LeftColumnClass ?>"><?php echo $class_routine->time_end_min->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $class_routine_edit->RightColumnClass ?>"><div<?php echo $class_routine->time_end_min->CellAttributes() ?>>
...
<?php if ($class_routine->day->Visible) { // day ?>
	<div id="r_day" class="form-group">
		<label id="elh_class_routine_day" for="x_day" class="<?php echo $class_routine_edit->LeftColumnClass ?>"><?php echo $class_routine->day->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $class_routine_edit->RightColumnClass ?>"><div<?php echo $class_routine->day->CellAttributes() ?>>
...
<?php if (!$class_routine_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $class_routine_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $class_routine_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fclass_routineedit.Init();
</script>
<?php
$class_routine_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$class_routine_edit->Page_Terminate();
?>
