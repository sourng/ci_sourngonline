...
class cdocument_add extends cdocument {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["document_id"] != "") {
				...
				$this->setKey("document_id", $this->document_id->CurrentValue); // Set up key
			} else {
				$this->setKey("document_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "documentview.php")
	...
	function LoadDefaultValues() {
		...
		$this->document_id->OldValue = $this->document_id->CurrentValue;
		...
		$this->file_type->CurrentValue = NULL;
		$this->file_type->OldValue = $this->file_type->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['document_id'] = $this->document_id->CurrentValue;
		$row['title'] = $this->title->CurrentValue;
		$row['description'] = $this->description->CurrentValue;
		$row['file_name'] = $this->file_name->CurrentValue;
		$row['file_type'] = $this->file_type->CurrentValue;
...
var CurrentForm = fdocumentadd = new ew_Form("fdocumentadd", "add");

// Validate form
fdocumentadd.Validate = function() {
...
fdocumentadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fdocumentadd" id="fdocumentadd" class="<?php echo $document_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($document_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $document_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="document">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($document_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($document->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_document_title" for="x_title" class="<?php echo $document_add->LeftColumnClass ?>"><?php echo $document->title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $document_add->RightColumnClass ?>"><div<?php echo $document->title->CellAttributes() ?>>
...
<?php if ($document->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_document_description" for="x_description" class="<?php echo $document_add->LeftColumnClass ?>"><?php echo $document->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $document_add->RightColumnClass ?>"><div<?php echo $document->description->CellAttributes() ?>>
...
<?php if ($document->file_name->Visible) { // file_name ?>
	<div id="r_file_name" class="form-group">
		<label id="elh_document_file_name" for="x_file_name" class="<?php echo $document_add->LeftColumnClass ?>"><?php echo $document->file_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $document_add->RightColumnClass ?>"><div<?php echo $document->file_name->CellAttributes() ?>>
...
<?php if ($document->file_type->Visible) { // file_type ?>
	<div id="r_file_type" class="form-group">
		<label id="elh_document_file_type" for="x_file_type" class="<?php echo $document_add->LeftColumnClass ?>"><?php echo $document->file_type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $document_add->RightColumnClass ?>"><div<?php echo $document->file_type->CellAttributes() ?>>
...
<?php if ($document->class_id->Visible) { // class_id ?>
	<div id="r_class_id" class="form-group">
		<label id="elh_document_class_id" for="x_class_id" class="<?php echo $document_add->LeftColumnClass ?>"><?php echo $document->class_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $document_add->RightColumnClass ?>"><div<?php echo $document->class_id->CellAttributes() ?>>
...
<?php if ($document->teacher_id->Visible) { // teacher_id ?>
	<div id="r_teacher_id" class="form-group">
		<label id="elh_document_teacher_id" for="x_teacher_id" class="<?php echo $document_add->LeftColumnClass ?>"><?php echo $document->teacher_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $document_add->RightColumnClass ?>"><div<?php echo $document->teacher_id->CellAttributes() ?>>
...
<?php if ($document->timestamp->Visible) { // timestamp ?>
	<div id="r_timestamp" class="form-group">
		<label id="elh_document_timestamp" for="x_timestamp" class="<?php echo $document_add->LeftColumnClass ?>"><?php echo $document->timestamp->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $document_add->RightColumnClass ?>"><div<?php echo $document->timestamp->CellAttributes() ?>>
...
<?php if (!$document_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $document_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $document_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
