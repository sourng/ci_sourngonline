	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("documentlist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fdocumentdelete = new ew_Form("fdocumentdelete", "delete");
...
fdocumentdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fdocumentdelete" id="fdocumentdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($document_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $document_delete->Token ?>">
<?php } ?>
...
<?php if ($document->document_id->Visible) { // document_id ?>
		<th class="<?php echo $document->document_id->HeaderCellClass() ?>"><span id="elh_document_document_id" class="document_document_id"><?php echo $document->document_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($document->teacher_id->Visible) { // teacher_id ?>
		<th class="<?php echo $document->teacher_id->HeaderCellClass() ?>"><span id="elh_document_teacher_id" class="document_teacher_id"><?php echo $document->teacher_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($document->document_id->Visible) { // document_id ?>
		<td<?php echo $document->document_id->CellAttributes() ?>>
<span id="el<?php echo $document_delete->RowCnt ?>_document_document_id" class="document_document_id">
...
<?php } ?>
<?php if ($document->teacher_id->Visible) { // teacher_id ?>
		<td<?php echo $document->teacher_id->CellAttributes() ?>>
<span id="el<?php echo $document_delete->RowCnt ?>_document_teacher_id" class="document_teacher_id">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $document_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
