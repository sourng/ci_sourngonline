...
class cdocument_view extends cdocument {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["document_id"] <> "") {
			$this->RecKey["document_id"] = $_GET["document_id"];
			$KeyUrl .= "&amp;document_id=" . urlencode($this->RecKey["document_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["document_id"] <> "") {
				...
				$this->RecKey["document_id"] = $this->document_id->QueryStringValue;
			} elseif (@$_POST["document_id"] <> "") {
				$this->document_id->setFormValue($_POST["document_id"]);
				$this->RecKey["document_id"] = $this->document_id->FormValue;
			} else {
...
var CurrentForm = fdocumentview = new ew_Form("fdocumentview", "view");
...
fdocumentview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $document_view->ExportOptions->Render("body") ?>
<?php
	foreach ($document_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fdocumentview" id="fdocumentview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($document_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $document_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="document">
<input type="hidden" name="modal" value="<?php echo intval($document_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($document->document_id->Visible) { // document_id ?>
	<tr id="r_document_id">
		<td class="col-sm-2"><span id="elh_document_document_id"><?php echo $document->document_id->FldCaption() ?></span></td>
...
<?php echo $document->document_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($document->title->Visible) { // title ?>
	<tr id="r_title">
		<td class="col-sm-2"><span id="elh_document_title"><?php echo $document->title->FldCaption() ?></span></td>
		<td data-name="title"<?php echo $document->title->CellAttributes() ?>>
...
<?php if ($document->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_document_description"><?php echo $document->description->FldCaption() ?></span></td>
		<td data-name="description"<?php echo $document->description->CellAttributes() ?>>
<span id="el_document_description">
<span<?php echo $document->description->ViewAttributes() ?>>
<?php echo $document->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($document->file_name->Visible) { // file_name ?>
	<tr id="r_file_name">
		<td class="col-sm-2"><span id="elh_document_file_name"><?php echo $document->file_name->FldCaption() ?></span></td>
		<td data-name="file_name"<?php echo $document->file_name->CellAttributes() ?>>
<span id="el_document_file_name">
<span<?php echo $document->file_name->ViewAttributes() ?>>
<?php echo $document->file_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($document->file_type->Visible) { // file_type ?>
	<tr id="r_file_type">
		<td class="col-sm-2"><span id="elh_document_file_type"><?php echo $document->file_type->FldCaption() ?></span></td>
		<td data-name="file_type"<?php echo $document->file_type->CellAttributes() ?>>
<span id="el_document_file_type">
<span<?php echo $document->file_type->ViewAttributes() ?>>
<?php echo $document->file_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($document->class_id->Visible) { // class_id ?>
	<tr id="r_class_id">
		<td class="col-sm-2"><span id="elh_document_class_id"><?php echo $document->class_id->FldCaption() ?></span></td>
		<td data-name="class_id"<?php echo $document->class_id->CellAttributes() ?>>
<span id="el_document_class_id">
<span<?php echo $document->class_id->ViewAttributes() ?>>
<?php echo $document->class_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($document->teacher_id->Visible) { // teacher_id ?>
	<tr id="r_teacher_id">
		<td class="col-sm-2"><span id="elh_document_teacher_id"><?php echo $document->teacher_id->FldCaption() ?></span></td>
...
<?php echo $document->teacher_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($document->timestamp->Visible) { // timestamp ?>
	<tr id="r_timestamp">
		<td class="col-sm-2"><span id="elh_document_timestamp"><?php echo $document->timestamp->FldCaption() ?></span></td>
		<td data-name="timestamp"<?php echo $document->timestamp->CellAttributes() ?>>
