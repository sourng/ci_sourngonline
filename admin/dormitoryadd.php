...
$dormitory_add = NULL; // Initialize page object first

class cdormitory_add extends cdormitory {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["dormitory_id"] != "") {
				...
				$this->setKey("dormitory_id", $this->dormitory_id->CurrentValue); // Set up key
			} else {
				$this->setKey("dormitory_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "dormitoryview.php")
	...
	function LoadDefaultValues() {
		...
		$this->number_of_room->CurrentValue = NULL;
		$this->number_of_room->OldValue = $this->number_of_room->CurrentValue;
	...
	function NewRow() {
		...
		$row['number_of_room'] = $this->number_of_room->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// number_of_room
		$this->number_of_room->SetDbValueDef($rsnew, $this->number_of_room->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($dormitory_add)) $dormitory_add = new cdormitory_add();

// Page init
$dormitory_add->Page_Init();

// Page main
$dormitory_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$dormitory_add->Page_Render();
?>
...
var CurrentForm = fdormitoryadd = new ew_Form("fdormitoryadd", "add");

// Validate form
fdormitoryadd.Validate = function() {
...
fdormitoryadd.Form_CustomValidate = 
...
fdormitoryadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $dormitory_add->ShowPageHeader(); ?>
<?php
$dormitory_add->ShowMessage();
?>
<form name="fdormitoryadd" id="fdormitoryadd" class="<?php echo $dormitory_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($dormitory_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $dormitory_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="dormitory">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($dormitory_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($dormitory->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_dormitory_name" for="x_name" class="<?php echo $dormitory_add->LeftColumnClass ?>"><?php echo $dormitory->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dormitory_add->RightColumnClass ?>"><div<?php echo $dormitory->name->CellAttributes() ?>>
...
<?php if ($dormitory->number_of_room->Visible) { // number_of_room ?>
	<div id="r_number_of_room" class="form-group">
		<label id="elh_dormitory_number_of_room" for="x_number_of_room" class="<?php echo $dormitory_add->LeftColumnClass ?>"><?php echo $dormitory->number_of_room->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dormitory_add->RightColumnClass ?>"><div<?php echo $dormitory->number_of_room->CellAttributes() ?>>
...
<?php if ($dormitory->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_dormitory_description" for="x_description" class="<?php echo $dormitory_add->LeftColumnClass ?>"><?php echo $dormitory->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dormitory_add->RightColumnClass ?>"><div<?php echo $dormitory->description->CellAttributes() ?>>
...
<?php if (!$dormitory_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $dormitory_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $dormitory_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
