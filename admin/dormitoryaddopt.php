...
$dormitory_addopt = NULL; // Initialize page object first

class cdormitory_addopt extends cdormitory {
	...
	// Page object name
	var $PageObjName = 'dormitory_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_dormitory_id"] = $this->dormitory_id->DbValue;
					$row["x_name"] = ew_ConvertToUtf8($this->name->DbValue);
					$row["x_number_of_room"] = ew_ConvertToUtf8($this->number_of_room->DbValue);
	...
	function LoadFormValues() {
		...
		if (!$this->number_of_room->FldIsDetailKey) {
			$this->number_of_room->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_number_of_room")));
		}
	...
	function RestoreFormValues() {
		...
		$this->number_of_room->CurrentValue = ew_ConvertToUtf8($this->number_of_room->FormValue);
...
// Create page object
if (!isset($dormitory_addopt)) $dormitory_addopt = new cdormitory_addopt();

// Page init
$dormitory_addopt->Page_Init();

// Page main
$dormitory_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$dormitory_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = fdormitoryaddopt = new ew_Form("fdormitoryaddopt", "addopt");

// Validate form
fdormitoryaddopt.Validate = function() {
...
fdormitoryaddopt.Form_CustomValidate = 
...
fdormitoryaddopt.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php
$dormitory_addopt->ShowMessage();
?>
<form name="fdormitoryaddopt" id="fdormitoryaddopt" class="ewForm form-horizontal" action="dormitoryaddopt.php" method="post">
<?php if ($dormitory_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $dormitory_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="dormitory">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($dormitory->name->Visible) { // name ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_name"><?php echo $dormitory->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php if ($dormitory->number_of_room->Visible) { // number_of_room ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_number_of_room"><?php echo $dormitory->number_of_room->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php if ($dormitory->description->Visible) { // description ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_description"><?php echo $dormitory->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php
$dormitory_addopt->Page_Terminate();
?>
