...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("studentlist.php"); // Exit and go to default page
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("teacherlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("adminlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("booklist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("classlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("lessonslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("settingslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("slideslist.php");
		if ($Security->IsLoggedIn())
