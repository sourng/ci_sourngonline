...
$payment_add = NULL; // Initialize page object first

class cpayment_add extends cpayment {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "paymentview.php")
	...
	function LoadDefaultValues() {
		...
		$this->payment_id->OldValue = $this->payment_id->CurrentValue;
		$this->expense_category_id->CurrentValue = NULL;
		$this->expense_category_id->OldValue = $this->expense_category_id->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['payment_id'] = $this->payment_id->CurrentValue;
		$row['expense_category_id'] = $this->expense_category_id->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// expense_category_id
		$this->expense_category_id->SetDbValueDef($rsnew, $this->expense_category_id->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($payment_add)) $payment_add = new cpayment_add();

// Page init
$payment_add->Page_Init();

// Page main
$payment_add->Page_Main();
...
var CurrentForm = fpaymentadd = new ew_Form("fpaymentadd", "add");
...
fpaymentadd.Form_CustomValidate = 
...
fpaymentadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fpaymentadd" id="fpaymentadd" class="<?php echo $payment_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($payment_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $payment_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="payment">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($payment_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($payment->expense_category_id->Visible) { // expense_category_id ?>
	<div id="r_expense_category_id" class="form-group">
		<label id="elh_payment_expense_category_id" for="x_expense_category_id" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->expense_category_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->expense_category_id->CellAttributes() ?>>
...
<?php if ($payment->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_payment_title" for="x_title" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->title->CellAttributes() ?>>
...
<?php if ($payment->payment_type->Visible) { // payment_type ?>
	<div id="r_payment_type" class="form-group">
		<label id="elh_payment_payment_type" for="x_payment_type" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->payment_type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->payment_type->CellAttributes() ?>>
...
<?php if ($payment->invoice_id->Visible) { // invoice_id ?>
	<div id="r_invoice_id" class="form-group">
		<label id="elh_payment_invoice_id" for="x_invoice_id" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->invoice_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->invoice_id->CellAttributes() ?>>
...
<?php if ($payment->student_id->Visible) { // student_id ?>
	<div id="r_student_id" class="form-group">
		<label id="elh_payment_student_id" for="x_student_id" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->student_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->student_id->CellAttributes() ?>>
...
<?php if ($payment->method->Visible) { // method ?>
	<div id="r_method" class="form-group">
		<label id="elh_payment_method" for="x_method" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->method->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->method->CellAttributes() ?>>
...
<?php if ($payment->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_payment_description" for="x_description" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->description->CellAttributes() ?>>
...
<?php if ($payment->amount->Visible) { // amount ?>
	<div id="r_amount" class="form-group">
		<label id="elh_payment_amount" for="x_amount" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->amount->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->amount->CellAttributes() ?>>
...
<?php if ($payment->timestamp->Visible) { // timestamp ?>
	<div id="r_timestamp" class="form-group">
		<label id="elh_payment_timestamp" for="x_timestamp" class="<?php echo $payment_add->LeftColumnClass ?>"><?php echo $payment->timestamp->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $payment_add->RightColumnClass ?>"><div<?php echo $payment->timestamp->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $payment_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
