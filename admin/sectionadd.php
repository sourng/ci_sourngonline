...
$section_add = NULL; // Initialize page object first

class csection_add extends csection {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["section_id"] != "") {
				...
				$this->setKey("section_id", $this->section_id->CurrentValue); // Set up key
			} else {
				$this->setKey("section_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "sectionview.php")
...
// Create page object
if (!isset($section_add)) $section_add = new csection_add();

// Page init
$section_add->Page_Init();

// Page main
$section_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$section_add->Page_Render();
?>
...
var CurrentForm = fsectionadd = new ew_Form("fsectionadd", "add");

// Validate form
fsectionadd.Validate = function() {
...
fsectionadd.Form_CustomValidate = 
...
fsectionadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $section_add->ShowPageHeader(); ?>
<?php
$section_add->ShowMessage();
?>
<form name="fsectionadd" id="fsectionadd" class="<?php echo $section_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($section_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $section_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="section">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($section_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($section->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_section_name" for="x_name" class="<?php echo $section_add->LeftColumnClass ?>"><?php echo $section->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $section_add->RightColumnClass ?>"><div<?php echo $section->name->CellAttributes() ?>>
...
<?php if ($section->nick_name->Visible) { // nick_name ?>
	<div id="r_nick_name" class="form-group">
		<label id="elh_section_nick_name" for="x_nick_name" class="<?php echo $section_add->LeftColumnClass ?>"><?php echo $section->nick_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $section_add->RightColumnClass ?>"><div<?php echo $section->nick_name->CellAttributes() ?>>
...
<?php if ($section->class_id->Visible) { // class_id ?>
	<div id="r_class_id" class="form-group">
		<label id="elh_section_class_id" for="x_class_id" class="<?php echo $section_add->LeftColumnClass ?>"><?php echo $section->class_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $section_add->RightColumnClass ?>"><div<?php echo $section->class_id->CellAttributes() ?>>
...
<?php if ($section->teacher_id->Visible) { // teacher_id ?>
	<div id="r_teacher_id" class="form-group">
		<label id="elh_section_teacher_id" for="x_teacher_id" class="<?php echo $section_add->LeftColumnClass ?>"><?php echo $section->teacher_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $section_add->RightColumnClass ?>"><div<?php echo $section->teacher_id->CellAttributes() ?>>
...
<?php if (!$section_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $section_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $section_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
