...
$section_edit = NULL; // Initialize page object first

class csection_edit extends csection {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_section_id")) {
			...
			if (isset($_GET["section_id"])) {
				$this->section_id->setQueryStringValue($_GET["section_id"]);
				$loadByQuery = TRUE;
			} else {
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->Page_Terminate("sectionlist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "sectionlist.php")
	...
	function LoadFormValues() {
		...
		if (!$this->nick_name->FldIsDetailKey) {
			$this->nick_name->setFormValue($objForm->GetValue("x_nick_name"));
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// nick_name
			$this->nick_name->SetDbValueDef($rsnew, $this->nick_name->CurrentValue, "", $this->nick_name->ReadOnly);
...
// Create page object
if (!isset($section_edit)) $section_edit = new csection_edit();

// Page init
$section_edit->Page_Init();

// Page main
$section_edit->Page_Main();
...
var CurrentForm = fsectionedit = new ew_Form("fsectionedit", "edit");
...
fsectionedit.Form_CustomValidate = 
...
fsectionedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fsectionedit" id="fsectionedit" class="<?php echo $section_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($section_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $section_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="section">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($section_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($section->section_id->Visible) { // section_id ?>
	<div id="r_section_id" class="form-group">
		<label id="elh_section_section_id" class="<?php echo $section_edit->LeftColumnClass ?>"><?php echo $section->section_id->FldCaption() ?></label>
		<div class="<?php echo $section_edit->RightColumnClass ?>"><div<?php echo $section->section_id->CellAttributes() ?>>
<span id="el_section_section_id">
<span<?php echo $section->section_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $section->section_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="section" data-field="x_section_id" name="x_section_id" id="x_section_id" value="<?php echo ew_HtmlEncode($section->section_id->CurrentValue) ?>">
<?php echo $section->section_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($section->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_section_name" for="x_name" class="<?php echo $section_edit->LeftColumnClass ?>"><?php echo $section->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $section_edit->RightColumnClass ?>"><div<?php echo $section->name->CellAttributes() ?>>
<span id="el_section_name">
...
<?php echo $section->name->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($section->nick_name->Visible) { // nick_name ?>
	<div id="r_nick_name" class="form-group">
		<label id="elh_section_nick_name" for="x_nick_name" class="<?php echo $section_edit->LeftColumnClass ?>"><?php echo $section->nick_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $section_edit->RightColumnClass ?>"><div<?php echo $section->nick_name->CellAttributes() ?>>
<span id="el_section_nick_name">
...
<?php echo $section->nick_name->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($section->class_id->Visible) { // class_id ?>
	<div id="r_class_id" class="form-group">
		<label id="elh_section_class_id" for="x_class_id" class="<?php echo $section_edit->LeftColumnClass ?>"><?php echo $section->class_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $section_edit->RightColumnClass ?>"><div<?php echo $section->class_id->CellAttributes() ?>>
<span id="el_section_class_id">
...
<?php echo $section->class_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($section->teacher_id->Visible) { // teacher_id ?>
	<div id="r_teacher_id" class="form-group">
		<label id="elh_section_teacher_id" for="x_teacher_id" class="<?php echo $section_edit->LeftColumnClass ?>"><?php echo $section->teacher_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $section_edit->RightColumnClass ?>"><div<?php echo $section->teacher_id->CellAttributes() ?>>
<span id="el_section_teacher_id">
...
<?php echo $section->teacher_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $section_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
