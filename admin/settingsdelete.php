...
fsettingsdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($settings->settings_id->Visible) { // settings_id ?>
		<th class="<?php echo $settings->settings_id->HeaderCellClass() ?>"><span id="elh_settings_settings_id" class="settings_settings_id"><?php echo $settings->settings_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($settings->settings_id->Visible) { // settings_id ?>
		<td<?php echo $settings->settings_id->CellAttributes() ?>>
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_settings_id" class="settings_settings_id">
