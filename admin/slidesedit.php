...
$slides_edit = NULL; // Initialize page object first

class cslides_edit extends cslides {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// slide_name
			$this->slide_name->SetDbValueDef($rsnew, $this->slide_name->CurrentValue, NULL, $this->slide_name->ReadOnly);

			// slide_image
			$this->slide_image->SetDbValueDef($rsnew, $this->slide_image->CurrentValue, NULL, $this->slide_image->ReadOnly);

			// slide_url
			$this->slide_url->SetDbValueDef($rsnew, $this->slide_url->CurrentValue, NULL, $this->slide_url->ReadOnly);

			// show
			$this->show->SetDbValueDef($rsnew, $this->show->CurrentValue, NULL, $this->show->ReadOnly);
...
// Create page object
if (!isset($slides_edit)) $slides_edit = new cslides_edit();

// Page init
$slides_edit->Page_Init();

// Page main
$slides_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$slides_edit->Page_Render();
?>
...
var CurrentForm = fslidesedit = new ew_Form("fslidesedit", "edit");

// Validate form
fslidesedit.Validate = function() {
...
fslidesedit.Form_CustomValidate = 
...
fslidesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $slides_edit->ShowPageHeader(); ?>
<?php
$slides_edit->ShowMessage();
?>
<form name="fslidesedit" id="fslidesedit" class="<?php echo $slides_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($slides_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $slides_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="slides">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($slides_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($slides->slide_id->Visible) { // slide_id ?>
	<div id="r_slide_id" class="form-group">
		<label id="elh_slides_slide_id" class="<?php echo $slides_edit->LeftColumnClass ?>"><?php echo $slides->slide_id->FldCaption() ?></label>
		<div class="<?php echo $slides_edit->RightColumnClass ?>"><div<?php echo $slides->slide_id->CellAttributes() ?>>
<span id="el_slides_slide_id">
<span<?php echo $slides->slide_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $slides->slide_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="slides" data-field="x_slide_id" name="x_slide_id" id="x_slide_id" value="<?php echo ew_HtmlEncode($slides->slide_id->CurrentValue) ?>">
<?php echo $slides->slide_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($slides->slide_name->Visible) { // slide_name ?>
	<div id="r_slide_name" class="form-group">
		<label id="elh_slides_slide_name" for="x_slide_name" class="<?php echo $slides_edit->LeftColumnClass ?>"><?php echo $slides->slide_name->FldCaption() ?></label>
		<div class="<?php echo $slides_edit->RightColumnClass ?>"><div<?php echo $slides->slide_name->CellAttributes() ?>>
...
<?php if ($slides->slide_image->Visible) { // slide_image ?>
	<div id="r_slide_image" class="form-group">
		<label id="elh_slides_slide_image" for="x_slide_image" class="<?php echo $slides_edit->LeftColumnClass ?>"><?php echo $slides->slide_image->FldCaption() ?></label>
		<div class="<?php echo $slides_edit->RightColumnClass ?>"><div<?php echo $slides->slide_image->CellAttributes() ?>>
...
<?php if ($slides->slide_url->Visible) { // slide_url ?>
	<div id="r_slide_url" class="form-group">
		<label id="elh_slides_slide_url" for="x_slide_url" class="<?php echo $slides_edit->LeftColumnClass ?>"><?php echo $slides->slide_url->FldCaption() ?></label>
		<div class="<?php echo $slides_edit->RightColumnClass ?>"><div<?php echo $slides->slide_url->CellAttributes() ?>>
...
<?php if ($slides->show->Visible) { // show ?>
	<div id="r_show" class="form-group">
		<label id="elh_slides_show" for="x_show" class="<?php echo $slides_edit->LeftColumnClass ?>"><?php echo $slides->show->FldCaption() ?></label>
		<div class="<?php echo $slides_edit->RightColumnClass ?>"><div<?php echo $slides->show->CellAttributes() ?>>
...
<?php if (!$slides_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $slides_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $slides_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
