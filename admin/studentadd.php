...
class cstudent_add extends cstudent {
	...
	function LoadDefaultValues() {
		...
		$this->roll->CurrentValue = NULL;
		$this->roll->OldValue = $this->roll->CurrentValue;
		...
		$this->dormitory_id->OldValue = $this->dormitory_id->CurrentValue;
		$this->dormitory_room_number->CurrentValue = NULL;
		$this->dormitory_room_number->OldValue = $this->dormitory_room_number->CurrentValue;
	...
	function NewRow() {
		...
		$row['roll'] = $this->roll->CurrentValue;
		$row['transport_id'] = $this->transport_id->CurrentValue;
		$row['dormitory_id'] = $this->dormitory_id->CurrentValue;
		$row['dormitory_room_number'] = $this->dormitory_room_number->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// class_id
		$this->class_id->SetDbValueDef($rsnew, $this->class_id->CurrentValue, "", FALSE);
		...
		// roll
		$this->roll->SetDbValueDef($rsnew, $this->roll->CurrentValue, "", FALSE);

		// transport_id
		$this->transport_id->SetDbValueDef($rsnew, $this->transport_id->CurrentValue, 0, FALSE);

		// dormitory_id
		$this->dormitory_id->SetDbValueDef($rsnew, $this->dormitory_id->CurrentValue, 0, FALSE);

		// dormitory_room_number
		$this->dormitory_room_number->SetDbValueDef($rsnew, $this->dormitory_room_number->CurrentValue, "", FALSE);
		...
		if ($this->image->Visible && !$this->image->Upload->KeepFile) {
			...
			if (!ew_Empty($this->image->Upload->FileName)) {
				...
				$this->image->SetDbValueDef($rsnew, $this->image->Upload->FileName, "", strval($this->image->CurrentValue) == "");
			}
		}
...
fstudentadd.Lists["x_sex"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstudentadd.Lists["x_sex"].Options = <?php echo json_encode($student_add->sex->Options()) ?>;
fstudentadd.Lists["x_blood_group"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstudentadd.Lists["x_blood_group"].Options = <?php echo json_encode($student_add->blood_group->Options()) ?>;
fstudentadd.Lists["x_class_id"] = {"LinkField":"x_class_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"class"};
fstudentadd.Lists["x_class_id"].Data = "<?php echo $student_add->class_id->LookupFilterQuery(FALSE, "add") ?>";
fstudentadd.Lists["x_section_id"] = {"LinkField":"x_section_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"section"};
fstudentadd.Lists["x_section_id"].Data = "<?php echo $student_add->section_id->LookupFilterQuery(FALSE, "add") ?>";
fstudentadd.Lists["x_parent_id"] = {"LinkField":"x_parent_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","x_phone","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"parent"};
fstudentadd.Lists["x_parent_id"].Data = "<?php echo $student_add->parent_id->LookupFilterQuery(FALSE, "add") ?>";
fstudentadd.Lists["x_transport_id"] = {"LinkField":"x_transport_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_route_name","x_number_of_vehicle","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"transport"};
fstudentadd.Lists["x_transport_id"].Data = "<?php echo $student_add->transport_id->LookupFilterQuery(FALSE, "add") ?>";
fstudentadd.Lists["x_dormitory_id"] = {"LinkField":"x_dormitory_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","x_number_of_room","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"dormitory"};
fstudentadd.Lists["x_dormitory_id"].Data = "<?php echo $student_add->dormitory_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($student->birthday->Visible) { // birthday ?>
	<div id="r_birthday" class="form-group">
		<label id="elh_student_birthday" for="x_birthday" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->birthday->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->birthday->CellAttributes() ?>>
...
<?php if ($student->sex->Visible) { // sex ?>
	<div id="r_sex" class="form-group">
		<label id="elh_student_sex" for="x_sex" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->sex->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->sex->CellAttributes() ?>>
...
<?php if ($student->religion->Visible) { // religion ?>
	<div id="r_religion" class="form-group">
		<label id="elh_student_religion" for="x_religion" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->religion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->religion->CellAttributes() ?>>
...
<?php if ($student->blood_group->Visible) { // blood_group ?>
	<div id="r_blood_group" class="form-group">
		<label id="elh_student_blood_group" for="x_blood_group" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->blood_group->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->blood_group->CellAttributes() ?>>
...
<?php if ($student->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_student_address" for="x_address" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->address->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->address->CellAttributes() ?>>
...
<?php if ($student->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_student_phone" for="x_phone" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->phone->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->phone->CellAttributes() ?>>
...
<?php if ($student->password->Visible) { // password ?>
	<div id="r_password" class="form-group">
		<label id="elh_student_password" for="x_password" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->password->CellAttributes() ?>>
<span id="el_student_password">
<input type="password" data-field="x_password" name="x_password" id="x_password" placeholder="<?php echo ew_HtmlEncode($student->password->getPlaceHolder()) ?>"<?php echo $student->password->EditAttributes() ?>>
</span>
...
<?php if ($student->class_id->Visible) { // class_id ?>
	<div id="r_class_id" class="form-group">
		<label id="elh_student_class_id" for="x_class_id" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->class_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->class_id->CellAttributes() ?>>
...
<?php if ($student->section_id->Visible) { // section_id ?>
	<div id="r_section_id" class="form-group">
		<label id="elh_student_section_id" for="x_section_id" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->section_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->section_id->CellAttributes() ?>>
...
<?php if ($student->parent_id->Visible) { // parent_id ?>
	<div id="r_parent_id" class="form-group">
		<label id="elh_student_parent_id" for="x_parent_id" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->parent_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->parent_id->CellAttributes() ?>>
...
<?php if ($student->roll->Visible) { // roll ?>
	<div id="r_roll" class="form-group">
		<label id="elh_student_roll" for="x_roll" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->roll->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->roll->CellAttributes() ?>>
...
<?php if ($student->transport_id->Visible) { // transport_id ?>
	<div id="r_transport_id" class="form-group">
		<label id="elh_student_transport_id" for="x_transport_id" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->transport_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->transport_id->CellAttributes() ?>>
...
<?php if ($student->dormitory_id->Visible) { // dormitory_id ?>
	<div id="r_dormitory_id" class="form-group">
		<label id="elh_student_dormitory_id" for="x_dormitory_id" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->dormitory_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->dormitory_id->CellAttributes() ?>>
...
<?php if ($student->dormitory_room_number->Visible) { // dormitory_room_number ?>
	<div id="r_dormitory_room_number" class="form-group">
		<label id="elh_student_dormitory_room_number" for="x_dormitory_room_number" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->dormitory_room_number->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->dormitory_room_number->CellAttributes() ?>>
...
<?php if ($student->authentication_key->Visible) { // authentication_key ?>
	<div id="r_authentication_key" class="form-group">
		<label id="elh_student_authentication_key" for="x_authentication_key" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->authentication_key->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->authentication_key->CellAttributes() ?>>
...
<?php if ($student->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_student_image" class="<?php echo $student_add->LeftColumnClass ?>"><?php echo $student->image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_add->RightColumnClass ?>"><div<?php echo $student->image->CellAttributes() ?>>
