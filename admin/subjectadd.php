...
class csubject_add extends csubject {
	...
	function ValidateForm() {
		...
		if (in_array("class", $DetailTblVar) && $GLOBALS["class"]->DetailAdd) {
	...
	function AddRow($rsold = NULL) {
		...
		if (strval($this->teacher_id->CurrentValue) <> "") {
			$sMasterFilter = str_replace("@teacher_id@", ew_AdjustSql($this->teacher_id->CurrentValue, "DB"), $sMasterFilter);
		} else {
		...
		// image
		$this->image->SetDbValueDef($rsnew, $this->image->CurrentValue, "", strval($this->image->CurrentValue) == "");
		...
		if ($AddRow) {
			$DetailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("class", $DetailTblVar) && $GLOBALS["class"]->DetailAdd) {
				$GLOBALS["class"]->class_id->setSessionValue($this->class_id->CurrentValue); // Set master key
				if (!isset($GLOBALS["class_grid"])) $GLOBALS["class_grid"] = new cclass_grid(); // Get detail page object
				$AddRow = $GLOBALS["class_grid"]->GridInsert();
				if (!$AddRow)
					$GLOBALS["class"]->class_id->setSessionValue(""); // Clear master key if insert failed
			}
		}
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("class", $DetailTblVar)) {
				...
				if ($GLOBALS["class_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["class_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["class_grid"]->CurrentMode = "add";
					$GLOBALS["class_grid"]->CurrentAction = "gridadd";
...
<?php if ($subject->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_subject_name" for="x_name" class="<?php echo $subject_add->LeftColumnClass ?>"><?php echo $subject->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $subject_add->RightColumnClass ?>"><div<?php echo $subject->name->CellAttributes() ?>>
...
<?php if ($subject->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_subject_description" for="x_description" class="<?php echo $subject_add->LeftColumnClass ?>"><?php echo $subject->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $subject_add->RightColumnClass ?>"><div<?php echo $subject->description->CellAttributes() ?>>
...
<?php if ($subject->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_subject_image" for="x_image" class="<?php echo $subject_add->LeftColumnClass ?>"><?php echo $subject->image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($subject->class_id->Visible) { // class_id ?>
	<div id="r_class_id" class="form-group">
		<label id="elh_subject_class_id" for="x_class_id" class="<?php echo $subject_add->LeftColumnClass ?>"><?php echo $subject->class_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $subject_add->RightColumnClass ?>"><div<?php echo $subject->class_id->CellAttributes() ?>>
...
<?php if ($subject->teacher_id->Visible) { // teacher_id ?>
	<div id="r_teacher_id" class="form-group">
		<label id="elh_subject_teacher_id" for="x_teacher_id" class="<?php echo $subject_add->LeftColumnClass ?>"><?php echo $subject->teacher_id->FldCaption() ?></label>
		<div class="<?php echo $subject_add->RightColumnClass ?>"><div<?php echo $subject->teacher_id->CellAttributes() ?>>
...
<?php
	if (in_array("class", explode(",", $subject->getCurrentDetailTable())) && $class->DetailAdd) {
?>
