...
<?php if ($subject->class_id->Visible) { // class_id ?>
		<th class="<?php echo $subject->class_id->HeaderCellClass() ?>"><span id="elh_subject_class_id" class="subject_class_id"><?php echo $subject->class_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($subject->teacher_id->Visible) { // teacher_id ?>
		<th class="<?php echo $subject->teacher_id->HeaderCellClass() ?>"><span id="elh_subject_teacher_id" class="subject_teacher_id"><?php echo $subject->teacher_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $subject_delete->RowCnt ?>_subject_class_id" class="subject_class_id">
...
<span id="el<?php echo $subject_delete->RowCnt ?>_subject_teacher_id" class="subject_teacher_id">
