...
class csubject_view extends csubject {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["subject_id"] <> "") {
				...
				$sReturnUrl = "subjectlist.php"; // Return to list
			}
	...
	function SetupOtherOptions() {
		...
		// "detail_class"
		$item = &$option->Add("detail_class");
		$body = $Language->Phrase("ViewPageDetailLink") . $Language->TablePhrase("class", "TblCaption");
		...
		$links = "";
		if ($GLOBALS["class_grid"] && $GLOBALS["class_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			$links .= "<li><a class=\"ewRowLink ewDetailView\" data-action=\"view\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailViewLink")) . "\" href=\"" . ew_HtmlEncode($this->GetViewUrl(EW_TABLE_SHOW_DETAIL . "=class")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailViewLink")) . "</a></li>";
			if ($DetailViewTblVar <> "") $DetailViewTblVar .= ",";
			$DetailViewTblVar .= "class";
		}
		if ($GLOBALS["class_grid"] && $GLOBALS["class_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			$links .= "<li><a class=\"ewRowLink ewDetailEdit\" data-action=\"edit\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailEditLink")) . "\" href=\"" . ew_HtmlEncode($this->GetEditUrl(EW_TABLE_SHOW_DETAIL . "=class")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailEditLink")) . "</a></li>";
			if ($DetailEditTblVar <> "") $DetailEditTblVar .= ",";
			$DetailEditTblVar .= "class";
		}
		if ($GLOBALS["class_grid"] && $GLOBALS["class_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			$links .= "<li><a class=\"ewRowLink ewDetailCopy\" data-action=\"add\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailCopyLink")) . "\" href=\"" . ew_HtmlEncode($this->GetCopyUrl(EW_TABLE_SHOW_DETAIL . "=class")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailCopyLink")) . "</a></li>";
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("class", $DetailTblVar)) {
				...
				if ($GLOBALS["class_grid"]->DetailView) {
					$GLOBALS["class_grid"]->CurrentMode = "view";
...
<?php if ($subject->name->Visible) { // name ?>
	<tr id="r_name">
		<td class="col-sm-2"><span id="elh_subject_name"><?php echo $subject->name->FldCaption() ?></span></td>
		<td data-name="name"<?php echo $subject->name->CellAttributes() ?>>
<span id="el_subject_name">
<span<?php echo $subject->name->ViewAttributes() ?>>
<?php echo $subject->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($subject->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_subject_description"><?php echo $subject->description->FldCaption() ?></span></td>
		<td data-name="description"<?php echo $subject->description->CellAttributes() ?>>
<span id="el_subject_description">
<span<?php echo $subject->description->ViewAttributes() ?>>
<?php echo $subject->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $subject->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($subject->class_id->Visible) { // class_id ?>
	<tr id="r_class_id">
		<td class="col-sm-2"><span id="elh_subject_class_id"><?php echo $subject->class_id->FldCaption() ?></span></td>
...
<?php echo $subject->class_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($subject->teacher_id->Visible) { // teacher_id ?>
	<tr id="r_teacher_id">
		<td class="col-sm-2"><span id="elh_subject_teacher_id"><?php echo $subject->teacher_id->FldCaption() ?></span></td>
...
<?php echo $subject->teacher_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("class", explode(",", $subject->getCurrentDetailTable())) && $class->DetailView) {
?>
