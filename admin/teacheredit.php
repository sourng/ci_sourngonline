...
class cteacher_edit extends cteacher {
	...
	function RenderRow() {
		...
		$this->pinterest->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->teacher_image);
	...
	function ValidateForm() {
		...
		if (in_array("subject", $DetailTblVar) && $GLOBALS["subject"]->DetailEdit) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// teacher_image
			if ($this->teacher_image->Visible && !$this->teacher_image->ReadOnly && !$this->teacher_image->Upload->KeepFile) {
			...
			// twitter
			$this->twitter->SetDbValueDef($rsnew, $this->twitter->CurrentValue, "", $this->twitter->ReadOnly);

			// facebook
			$this->facebook->SetDbValueDef($rsnew, $this->facebook->CurrentValue, "", $this->facebook->ReadOnly);

			// google
			$this->google->SetDbValueDef($rsnew, $this->google->CurrentValue, "", $this->google->ReadOnly);

			// linkedin
			$this->linkedin->SetDbValueDef($rsnew, $this->linkedin->CurrentValue, "", $this->linkedin->ReadOnly);

			// pinterest
			$this->pinterest->SetDbValueDef($rsnew, $this->pinterest->CurrentValue, "", $this->pinterest->ReadOnly);
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("subject", $DetailTblVar) && $GLOBALS["subject"]->DetailEdit) {
						if (!isset($GLOBALS["subject_grid"])) $GLOBALS["subject_grid"] = new csubject_grid(); // Get detail page object
						$EditRow = $GLOBALS["subject_grid"]->GridUpdate();
					}
				}
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("subject", $DetailTblVar)) {
				...
				if ($GLOBALS["subject_grid"]->DetailEdit) {
					$GLOBALS["subject_grid"]->CurrentMode = "edit";
					$GLOBALS["subject_grid"]->CurrentAction = "gridedit";
...
fteacheredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fteacheredit.Lists["x_sex"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fteacheredit.Lists["x_sex"].Options = <?php echo json_encode($teacher_edit->sex->Options()) ?>;
fteacheredit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fteacheredit.Lists["x_active"].Options = <?php echo json_encode($teacher_edit->active->Options()) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($teacher_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($teacher->teacher_id->Visible) { // teacher_id ?>
	<div id="r_teacher_id" class="form-group">
		<label id="elh_teacher_teacher_id" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->teacher_id->FldCaption() ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->teacher_id->CellAttributes() ?>>
<span id="el_teacher_teacher_id">
<span<?php echo $teacher->teacher_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $teacher->teacher_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="teacher" data-field="x_teacher_id" data-page="1" name="x_teacher_id" id="x_teacher_id" value="<?php echo ew_HtmlEncode($teacher->teacher_id->CurrentValue) ?>">
<?php echo $teacher->teacher_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($teacher->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_teacher_name" for="x_name" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->name->CellAttributes() ?>>
...
<?php if ($teacher->birthday->Visible) { // birthday ?>
	<div id="r_birthday" class="form-group">
		<label id="elh_teacher_birthday" for="x_birthday" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->birthday->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->birthday->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fteacheredit", "x_birthday", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($teacher->sex->Visible) { // sex ?>
	<div id="r_sex" class="form-group">
		<label id="elh_teacher_sex" for="x_sex" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->sex->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->sex->CellAttributes() ?>>
...
<?php if ($teacher->religion->Visible) { // religion ?>
	<div id="r_religion" class="form-group">
		<label id="elh_teacher_religion" for="x_religion" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->religion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->religion->CellAttributes() ?>>
...
<?php if ($teacher->blood_group->Visible) { // blood_group ?>
	<div id="r_blood_group" class="form-group">
		<label id="elh_teacher_blood_group" for="x_blood_group" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->blood_group->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->blood_group->CellAttributes() ?>>
...
<?php if ($teacher->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_teacher_address" for="x_address" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->address->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->address->CellAttributes() ?>>
...
<?php if ($teacher->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_teacher_phone" for="x_phone" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->phone->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->phone->CellAttributes() ?>>
...
<?php if ($teacher->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_teacher__email" for="x__email" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->_email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->_email->CellAttributes() ?>>
...
<?php if ($teacher->password->Visible) { // password ?>
	<div id="r_password" class="form-group">
		<label id="elh_teacher_password" for="x_password" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->password->CellAttributes() ?>>
<span id="el_teacher_password">
<input type="password" data-field="x_password" name="x_password" id="x_password" value="<?php echo $teacher->password->EditValue ?>" placeholder="<?php echo ew_HtmlEncode($teacher->password->getPlaceHolder()) ?>"<?php echo $teacher->password->EditAttributes() ?>>
</span>
...
<?php if ($teacher->authentication_key->Visible) { // authentication_key ?>
	<div id="r_authentication_key" class="form-group">
		<label id="elh_teacher_authentication_key" for="x_authentication_key" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->authentication_key->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->authentication_key->CellAttributes() ?>>
...
<?php if ($teacher->photo->Visible) { // photo ?>
	<div id="r_photo" class="form-group">
		<label id="elh_teacher_photo" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->photo->FldCaption() ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->photo->CellAttributes() ?>>
...
<?php if ($teacher->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_teacher_active" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->active->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->active->CellAttributes() ?>>
...
<?php if ($teacher->teacher_image->Visible) { // teacher_image ?>
	<div id="r_teacher_image" class="form-group">
		<label id="elh_teacher_teacher_image" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->teacher_image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->teacher_image->CellAttributes() ?>>
...
<?php if (@$_POST["fa_x_teacher_image"] == "0") { ?>
<input type="hidden" name="fa_x_teacher_image" id= "fa_x_teacher_image" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_teacher_image" id= "fa_x_teacher_image" value="1">
<?php } ?>
...
<?php if ($teacher->twitter->Visible) { // twitter ?>
	<div id="r_twitter" class="form-group">
		<label id="elh_teacher_twitter" for="x_twitter" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->twitter->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->twitter->CellAttributes() ?>>
...
<?php if ($teacher->facebook->Visible) { // facebook ?>
	<div id="r_facebook" class="form-group">
		<label id="elh_teacher_facebook" for="x_facebook" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->facebook->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->facebook->CellAttributes() ?>>
...
<?php if ($teacher->google->Visible) { // google ?>
	<div id="r_google" class="form-group">
		<label id="elh_teacher_google" for="x_google" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->google->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->google->CellAttributes() ?>>
...
<?php if ($teacher->linkedin->Visible) { // linkedin ?>
	<div id="r_linkedin" class="form-group">
		<label id="elh_teacher_linkedin" for="x_linkedin" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->linkedin->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->linkedin->CellAttributes() ?>>
...
<?php if ($teacher->pinterest->Visible) { // pinterest ?>
	<div id="r_pinterest" class="form-group">
		<label id="elh_teacher_pinterest" for="x_pinterest" class="<?php echo $teacher_edit->LeftColumnClass ?>"><?php echo $teacher->pinterest->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teacher_edit->RightColumnClass ?>"><div<?php echo $teacher->pinterest->CellAttributes() ?>>
...
<?php
	if (in_array("subject", explode(",", $teacher->getCurrentDetailTable())) && $subject->DetailEdit) {
?>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $teacher_edit->OffsetColumnClass ?>"><!-- buttons offset -->
