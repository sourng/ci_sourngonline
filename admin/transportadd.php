...
$transport_add = NULL; // Initialize page object first

class ctransport_add extends ctransport {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["transport_id"] != "") {
				...
				$this->setKey("transport_id", $this->transport_id->CurrentValue); // Set up key
			} else {
				$this->setKey("transport_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "transportview.php")
...
// Create page object
if (!isset($transport_add)) $transport_add = new ctransport_add();

// Page init
$transport_add->Page_Init();

// Page main
$transport_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$transport_add->Page_Render();
?>
...
var CurrentForm = ftransportadd = new ew_Form("ftransportadd", "add");

// Validate form
ftransportadd.Validate = function() {
...
ftransportadd.Form_CustomValidate = 
...
ftransportadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $transport_add->ShowPageHeader(); ?>
<?php
$transport_add->ShowMessage();
?>
<form name="ftransportadd" id="ftransportadd" class="<?php echo $transport_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($transport_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $transport_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="transport">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($transport_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($transport->route_name->Visible) { // route_name ?>
	<div id="r_route_name" class="form-group">
		<label id="elh_transport_route_name" for="x_route_name" class="<?php echo $transport_add->LeftColumnClass ?>"><?php echo $transport->route_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $transport_add->RightColumnClass ?>"><div<?php echo $transport->route_name->CellAttributes() ?>>
...
<?php if ($transport->number_of_vehicle->Visible) { // number_of_vehicle ?>
	<div id="r_number_of_vehicle" class="form-group">
		<label id="elh_transport_number_of_vehicle" for="x_number_of_vehicle" class="<?php echo $transport_add->LeftColumnClass ?>"><?php echo $transport->number_of_vehicle->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $transport_add->RightColumnClass ?>"><div<?php echo $transport->number_of_vehicle->CellAttributes() ?>>
...
<?php if ($transport->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_transport_description" for="x_description" class="<?php echo $transport_add->LeftColumnClass ?>"><?php echo $transport->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $transport_add->RightColumnClass ?>"><div<?php echo $transport->description->CellAttributes() ?>>
...
<?php if ($transport->route_fare->Visible) { // route_fare ?>
	<div id="r_route_fare" class="form-group">
		<label id="elh_transport_route_fare" for="x_route_fare" class="<?php echo $transport_add->LeftColumnClass ?>"><?php echo $transport->route_fare->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $transport_add->RightColumnClass ?>"><div<?php echo $transport->route_fare->CellAttributes() ?>>
...
<?php if (!$transport_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $transport_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $transport_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
