...
class cusers extends cTable {
	...
	function __construct() {
		...
		// picture
		$this->picture = new cField('users', 'users', 'x_picture', 'picture', '`picture`', '`picture`', 200, -1, FALSE, '`picture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modified
		$this->modified = new cField('users', 'users', 'x_modified', 'modified', '`modified`', ew_CastDateFieldForLike('`modified`', 7, "DB"), 135, 7, FALSE, '`modified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modified->Sortable = TRUE; // Allow sort
		$this->modified->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateDMY"));
	...
	function RenderEditRow() {
		...
		$this->modified->EditValue = ew_FormatDateTime($this->modified->CurrentValue, 7);
